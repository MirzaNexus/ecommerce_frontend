...
export const NewsletterSubscribeForm = () => {
  ...
  const onSubmit = (data: SubscribeInput) => {
    // 🟢 Injecting FCM Token and calling our hook
    subscribe({ ...data, fcmToken: fcmToken || undefined });
    reset();
  };
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="bg-white text-indigo-600 px-8 py-3 rounded-xl font-black uppercase italic text-xs hover:bg-indigo-50 transition-transform active:scale-95 flex items-center justify-center min-w-[120px]"
            >
              {isSubscribing ? (
          ...
          {errors.email && (
            <p className="text-red-300 text-[10px] font-bold uppercase mt-2 text-left ml-2 tracking-widest">
